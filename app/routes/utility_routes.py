...
async def upload_label_structures_to_all_printers():
    try:
        ...
        # pallet_labels = upload_pallet_label_structures_to_printers(all_printers)
        box_labels = await upload_box_label_structures_to_printers(all_printers)
        # internal_labels = await upload_internal_label_structures_to_printers(all_printers)

        # return {"pallet": pallet_label_response, "box": box_label_response}
        return {"pallet": box_labels}
